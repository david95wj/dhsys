...
<script type="text/javascript">
                 ...
                 hidden:true
                  ...
                  width:'180'
    				...
    				formatter : function(value, row, index) {
    					var str = '';
    					    if ($.canUpdate) {
    							str += $.formatString('<img style="cursor:pointer" alt="变更角色" src="${ctx}/images/ext/edit.gif" onclick="doUpdate(\'{0}\')" ></img>', row.roleId);
    						}
    						str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
    						if ($.canRemove) {
    							str += $.formatString('<img style="cursor:pointer" alt="移除角色" src="${ctx}/images/ext/delete.gif" onclick="doRemove(\'{0}\')" ></img>', row.roleId);
    						}
    						str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
    						if ($.canGrant) {
    							str += $.formatString('<img style="cursor:pointer" alt="分配模块" src="${ctx}/images/ext/grant.gif" onclick="doGrant(\'{0}\')" ></img>', row.roleId);
    						}
    					     return str;
    				}
    			}
 ...
 function doRemove(roleId){
	   if(roleId==undefined){
	     ...
	     parent.$.messager.confirm('系统提示', '确定移除所选择的系统角色?', function(r) {  
		   if (r) {  
  ...
  function doGrant(){
  	  ...
  	  parent.$.modalDialog({
					...
					width : 600,
					height : 160,
					href : '${ctx}/dhsys/sysrole/grantModule.html?roleId='+row[0].roleId,
					buttons : [{
						    	  text : '确定分配',
						    	  iconCls:'icon-ok',
						          handler : function() {
							      parent.$.modalDialog.openner_dataGrid = dataGrid; 
							      var f = parent.$.modalDialog.handler.find('#grantModuleForm');
							      f.submit();   
						         }
						        },{
						         text : '取消分配',
